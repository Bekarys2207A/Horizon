"""
Django settings for horizweb project.
...
SECRET_KEY = 'django-insecure-om*un&rfqu8(vm5lfl7ah-zy4(%7n9pq-h*6xk6*w85xbk-mi1'
...
WSGI_APPLICATION = 'horizweb.wsgi.application'
